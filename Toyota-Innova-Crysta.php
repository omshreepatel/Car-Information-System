...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="row" id="swift">
                    <div class="col-12"><h3>Toyota Innova Crysta</h3></div>
                </div>
                <div class="row">
                    <div class="col-12 text-info">
                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                        &nbsp;  <span class="text-primary">1250 Reviews</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-12">
                <nav class="nav">
                    <li class="nav-item "><a href="#swift" class="nav-link active">Innova Crysta</a></li>
        ...
        <div class="row border mt-3 m-1">
            <div class="col-md-6 border-right">
                <div class="row">
                    <div class="col-12">
                        <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta1.jpg" alt="" class="img-fluid m-1">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-6 border">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <b class="pl-3 pt-1">2.7 GX 7 STR</b>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 border">
                    ...
                    <div class="col-12 ">
                       ...
                       <div class="col-12 bg-light p-2">
                        <p>EMI ₹ 30,520 &nbsp;<span style="font-size: 12px;">For 5 Years</span></p>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <h3>Toyota Innova Crysta Key Specifications</h3>
            </div>
            <div class="col-12 mt-3">
        ...
        <div class="row mt-3">
            <div class="col-12">
                <h3>Toyota Innova Crysta Summary</h3>
            </div>
            <div class="col-12 text-justify bg-light p-3 border" style="border-radius: 8px;">
            <p class="m-0">Toyota Kirloskar Motor has launched the facelift of the Innova Crysta for India The facelift was earlier unveiled in Indonesia featuring subtle exterior and interior updates. Most of the cosmetic changes have been carried over the Indian-spec model. We give you the details of what to expect from the new Innova Crysta.</p>
            <p class="collapse" id="pcollapse">The front fascia of the Innova Crysta facelift houses a large, blacked-out five-slat grille surrounded by chrome borders. The bumpers have also been tweaked with repositioned fog lamps and indicator lights and a body-colored faux skid plate at the bottom. The headlights along with new LED DRLs now extend into the front grille giving it a bit more refreshed look. The side and rear profile of the new model mostly remains unchanged except for the new design for the 16-inch (GX and VX variants) and 17-inch (ZX variant) alloy wheels which now get diamond-cut treatment. In a new, the front bumper now comes fitted with sonar clearance to help ease parking hassle in tight spaces.
            </p>
            <p class="collapse" id="pcollapse">Not much changes have been made to the cabin except for an updated nine-inch touchscreen infotainment system with Apple CarPlay and Android Auto connectivity. The seats on the higher-spec variants are wrapped in Camel Tan (beige) leather upholstery. Added vehicle connectivity features now include geofencing, real-time vehicle tracking and last parked locations.
            </p>
             <p class="collapse" id="pcollapse">The new Innova Crysta facelift will continue to be powered by the existing BS6 compliant 2.4-litre diesel motor that churns out 148bhp and 343Nm torque and the 2.7-litre petrol motor making 164bhp and 245Nm of torque. Both these powertrains are available with a five-speed manual and a six-speed automatic torque converter gearbox. The price of the new Innova Crysta has increased by Rs 50,000 – Rs 70,000 across the variants and the starting price now stands at Rs 16.26 lakh (ex-showroom, except Kerala).
            </p>
            <span id="Images"></span>
         ...
         <div class="row  mt-4 mb-0">
             <div class="col-12">
                 <h3>Toyota Innova Crysta Images</h3>
             </div>
         </div>
        <div class="row gallarys border">
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta1.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta1.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta2.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta2.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-12 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta3.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta3.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta4.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta4.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta5.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta5.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-12 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta6.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta6.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta7.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta7.jpg" class="img-fluid" alt="">
                </a>
            </div>
             <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta8.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta8.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-12 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta9.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta9.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-12 p-2 mt-2">
                <a href="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta10.jpg">
                    <img src="images/Toyota-Innova-Crysta/Toyota-Innova-Crysta10.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div>
