...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="row" id="swift">
                    <div class="col-12"><h3>Tata Safari</h3></div>
                </div>
                <div class="row">
                    <div class="col-12 text-info">
                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                        &nbsp;  <span class="text-primary">145 Reviews</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-12">
                <nav class="nav">
                    <li class="nav-item "><a href="#swift" class="nav-link active"> Safari</a></li>
        ...
        <div class="row border mt-3 m-1">
            <div class="col-md-6 border-right">
                <div class="row">
                    <div class="col-12">
                        <img src="images/tata-safari/tata-safari1.jpg" alt="" class="img-fluid m-1">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-12 ">
                       ...
                       <div class="col-12 bg-light p-2">
                        <p>EMI ₹ 27,573 &nbsp;<span style="font-size: 12px;">For 5 Years</span></p>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <h3>Tata Safari Key Specifications</h3>
            </div>
            <div class="col-12 mt-3">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col-md-4 border p-2 bg-light">
                                ...
                                <p class="m-0">₹ 17.82 Lakh onwards</p>
                            </div>
                            <div class="col-md-4 border p-2 bg-light">
                                <p class="m-0"><i class="fas fa-tachometer-alt"></i>
                                <b>MILEAGE</b></p>
                                <p class="m-0">14.08 to 16.14 kmpl</p>
                            </div>
                            <div class="col-md-4 border p-2 bg-light">
        ...
        <div class="row mt-3">
            <div class="col-12">
                <h3>Tata Safari Summary</h3>
            </div>
            <div class="col-12 text-justify bg-light p-3 border" style="border-radius: 8px;">
            <p class="m-0">The Tata Safari is back! Now as an urban SUV with six or seven seats and built on a stretched version of the platform which underpins the popular Harrier. Expected to launched as the Gravitas since it was first shown at the 2020 Auto Expo, Tata instead decide to resurrect the iconic Safari nameplate. The Safari will be offered in six trim levels with a total of nine variants and three colour options. The Tata Safari is expected to be priced from Rs 18 Lakh, ex-showroom when launched on 22 February 2021. </p>
            <p class="collapse" id="pcollapse">In terms of overall design, the Safari looks like a stretched version of the Harrier – which may or may not be a bad thing depending on your outlook. The faascia is mostly the same with subtle difference in the details like the grille inserts. The side profile gives the first hints of the changes made to the Safari, including the stepped roof, the extra rear overhang and the larger 18-inch wheels. At the rear, the Safari has a complete redesign, though it is similar to the design of the Harrier.</p>
            <p class="collapse" id="pcollapse">
            Step inside and the Safari looks even more like the Harrier, especially because of the dashboard design. The large panoramic sunroof, the third row of seats, optional captain seats in the second row, the soft-touch materials used on the dashboard and the upholstery colour theme are the only thing which set the Safari apart. In terms of features, the Safari gets optional second-row captain seats, ‘Boss Mode’ easy front passenger seat adjustment, multi drive modes, 7-inch touchscreen infotainment system, iRA connected car technology, nine-speaker JBL surround sound system, six-way powered driver seat, a panoramic sunroof and more.</p>
           
            <p class="collapse" id="pcollapse">The Safari will be offered with a single engine – a 2.0-litre, four-cylinder turbocharged ‘Kryotec’ diesel unit developing 168bhp of maximum power at 3750rpm and 350Nm of peak torque between 1750-2500rpm. This can be had with either a six-speed manual transmission or a six-speed automatic transmission. ARAI-certified mileage for the Safari have not been revealed as yet. We were expected Tata to debut a new petrol engine with the Safari, but that seems to have postponed to an unknown date.
            </p>
            <span id="Images"></span>
          ...
          <div class="row  mt-4 mb-0">
             <div class="col-12">
                 <h3>Tata Safari Images</h3>
             </div>
         </div>
        <div class="row gallarys border">
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari1.jpg">
                    <img src="images/tata-safari/tata-safari1.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari2.jpg">
                    <img src="images/tata-safari/tata-safari2.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-12 p-2 mt-2">
                <a href="images/tata-safari/tata-safari3.jpg">
                    <img src="images/tata-safari/tata-safari3.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari4.jpg">
                    <img src="images/tata-safari/tata-safari4.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari5.jpg">
                    <img src="images/tata-safari/tata-safari5.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-12 p-2 mt-2">
                <a href="images/tata-safari/tata-safari6.jpg">
                    <img src="images/tata-safari/tata-safari6.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari7.jpg">
                    <img src="images/tata-safari/tata-safari7.jpg" class="img-fluid" alt="">
                </a>
            </div>
             <div class="col-lg-4 col-md-6 col-6 p-2 mt-2">
                <a href="images/tata-safari/tata-safari8.jpg">
                    <img src="images/tata-safari/tata-safari8.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-12 p-2 mt-2">
                <a href="images/tata-safari/tata-safari9.jpg">
                    <img src="images/tata-safari/tata-safari9.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 col-12 p-2 mt-2">
                <a href="images/tata-safari/tata-safari10.jpg">
                    <img src="images/tata-safari/tata-safari10.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div>
    </div> 
